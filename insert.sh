...
curl --header "Content-Type: application/json" http://localhost:8080/account/insert -X POST -d '{"accountNameOwner":"aaa_aaa", "accountType":"credit", "moniker":"0000", "totals":0, "totalsBalanced":0, "dateClosed":0, "dateAdded":1593981072000, "dateUpdated":1593981072000,"activeStatus":true}'
exit 0
