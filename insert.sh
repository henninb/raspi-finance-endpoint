...
echo account
curl --header "Content-Type: application/json" http://localhost:8080/account/insert -X POST -d '{"accountNameOwner":"chase_brian", "accountType":"credit", "moniker":"0000", "totals":0, "totalsBalanced":0, "dateClosed":0, "dateAdded":1593981072000, "dateUpdated":1593981072000,"activeStatus":true}'

echo payment
echo
curl --header "Content-Type: application/json" http://localhost:8080/payment/insert -X POST -d '{"accountNameOwner": "chase_brian", "amount":1.55, "transactionDate":1593981072000 }'
