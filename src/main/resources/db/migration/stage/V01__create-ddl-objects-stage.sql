...
----------------------------
CREATE TABLE IF NOT EXISTS stage.t_validation_amount_date(
...
SELECT setval('stage.t_validation_amount_date_validation_id_seq', (SELECT MAX(validation_id) FROM stage.t_validation_amount_date) + 1);
