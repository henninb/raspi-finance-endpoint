-- V04: Create Family Member table (Stage)
...
CREATE INDEX IF NOT EXISTS idx_family_member_active ON public.t_family_member(active_status, owner);
CREATE INDEX IF NOT EXISTS idx_family_member_insurance ON public.t_family_member(insurance_member_id);

-- Insert test family members for staging
INSERT INTO public.t_family_member (owner, member_name, relationship, insurance_member_id) VALUES
('stage_user', 'stage_user', 'self', 'STAGE001'),
('stage_user', 'stage_spouse', 'spouse', 'STAGE002'),
('stage_user', 'stage_child1', 'child', 'STAGE003'),
('stage_user', 'stage_child2', 'child', 'STAGE004');