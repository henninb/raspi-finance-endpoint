...
class UserController(
    ...
    fun signUp(
        ...
        if (bindingResult.hasErrors()) {
            val errors = bindingResult.fieldErrors.associate { it.field to (it.defaultMessage ?: "Invalid") }
            return ResponseEntity.badRequest().body(writeJson(mapOf("errors" to errors)))
        }
