...
'''
    ...
    void 'test validation invalid #invalidField has error expectedError'() {
        ...
        'transactionDate'  | UUID.randomUUID()                      | 1003      | AccountType.Credit | TransactionType.Expense | 'one-chase_brian'  | LocalDate.of(1999, 12, 31)     | 'Cafe Roale'     | 'online' | 3.14G   | TransactionState.Cleared | ReoccurringType.Undefined | 'no notes' | 'date must be after 1/1/2000 and no more than 50 years in the future.' | 1
    }
