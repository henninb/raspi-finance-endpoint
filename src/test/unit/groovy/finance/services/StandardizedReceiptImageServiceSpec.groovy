...
/**
 * TDD Test Specification for StandardizedReceiptImageService
...
class StandardizedReceiptImageServiceSpec extends BaseServiceSpec {
    ...
    def standardizedReceiptImageService = new StandardizedReceiptImageService(receiptImageRepositoryMock)
