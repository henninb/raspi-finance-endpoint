...
class StandardizedPendingTransactionServiceSpec extends Specification {

    PendingTransactionRepository mockPendingTransactionRepository = Mock()
    Validator mockValidator = Mock()

    @Subject
    StandardizedPendingTransactionService standardizedPendingTransactionService

    def setup() {
        standardizedPendingTransactionService = new StandardizedPendingTransactionService(mockPendingTransactionRepository)
