-- V03: Create Medical Provider table (Oracle Test)
...
('ora_test_provider', 'general', NULL, 'in_network');
INSERT INTO t_medical_provider (provider_name, provider_type, specialty, network_status) VALUES
('ora_test_pharmacy', 'pharmacy', 'retail_pharmacy', 'in_network');
INSERT INTO t_medical_provider (provider_name, provider_type, specialty, network_status) VALUES
('ora_test_urgent_care', 'urgent_care', NULL, 'out_of_network');
INSERT INTO t_medical_provider (provider_name, provider_type, specialty, network_status) VALUES
('ora_test_hospital', 'hospital', NULL, 'in_network');
INSERT INTO t_medical_provider (provider_name, provider_type, specialty, network_status) VALUES
('ora_test_laboratory', 'laboratory', 'general_lab', 'in_network');
