...
VALUES ((select account_id from t_account where account_name_owner='foo_brian'), 'credit', 'foo_brian', 'aaaaaaaa-bbbb-cccc-dddd-1234567890de', '2020-09-04', 'current', 'online',
...
INSERT INTO func.t_transaction(account_id, account_type, account_name_owner, guid, transaction_date,
                          description, category, amount, transaction_state, reoccurring_type,
                          active_status, notes, receipt_image_id, date_updated, date_added)
VALUES ((select account_id from t_account where account_name_owner='foo_brian'), 'credit', 'foo_brian', 'aaaaaaaa-bbbb-cccc-dddd-1234567890ef', '2020-09-05', 'current', 'online',
...
INSERT INTO func.t_transaction(account_id, account_type, account_name_owner, guid, transaction_date,
                          description, category, amount, transaction_state, reoccurring_type,
                          active_status, notes, receipt_image_id, date_updated, date_added)
VALUES ((select account_id from t_account where account_name_owner='foo_brian'), 'credit', 'foo_brian', 'ba665bc2-22b6-4123-a566-6f5ab3d796dg', '2020-09-06', 'current', 'online',
...
INSERT INTO func.t_transaction(account_id, account_type, account_name_owner, guid, transaction_date,
                          description, category, amount, transaction_state, reoccurring_type,
                          active_status, notes, receipt_image_id, date_updated, date_added)
VALUES ((select account_id from t_account where account_name_owner='referenced_brian'), 'credit', 'referenced_brian', 'ba665bc2-22b6-4123-a566-6f5ab3d796dh', '2020-12-31', 'current',
...
INSERT INTO func.t_transaction(account_id, account_type, account_name_owner, guid, transaction_date,
                          description, category, amount, transaction_state, reoccurring_type,
                          active_status, notes, receipt_image_id, date_updated, date_added)
VALUES ((select account_id from t_account where account_name_owner='bank_brian'), 'debit', 'bank_brian', 'ba665bc2-22b6-4123-a566-6f5ab3d796di', '2020-12-31', 'current', 'online',
        11.95, 'cleared', 'undefined', true, '', null, '2020-10-27 18:51:06.903105',
        '2020-09-05 20:34:39.360139');

INSERT INTO func.t_payment (account_name_owner, transaction_date, amount, guid_source, guid_destination,
                       active_status, date_updated, date_added)
VALUES ('referenced_brian', '2020-12-31', 11.95, 'ba665bc2-22b6-4123-a566-6f5ab3d796dh',
...
VALUES ('payment_account', 'bank_brian', true, '2020-10-23 18:00:59.952200', '2020-10-23 18:00:59.952200');
